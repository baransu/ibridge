...
var ChildAPI = /*#__PURE__*/function (_Emittery) {
  ...
  function ChildAPI(model, context) {
    var _this;
  ...
  _createClass(ChildAPI, [{
    ...
    value: function () {
      var _dispatcher = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
        var data, type, kind, eventName, isHandshake, _ref, _eventName, _data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if ((0,_isValidEvent__WEBPACK_IMPORTED_MODULE_5__.default)(event, this.parentOrigin)) {
                  _context.next = 5;
                  break;
                }
              ...
              case 5:
                if (event.data.kind === _constants__WEBPACK_IMPORTED_MODULE_3__.PARENT_EMIT) {
                  _ref = event.data, _eventName = _ref.eventName, _data = _ref.data;
    ...
    value: function emitToParent(eventName, data) {
      ...
      this.parent.postMessage((0,_events__WEBPACK_IMPORTED_MODULE_4__.createChildEmit)(eventName, data), this.parentOrigin);
    }
  }, {
    key: "handshake",
    value: function () {
...
var ParentAPI = /*#__PURE__*/function (_Emittery) {
  ...
  function ParentAPI(_ref) {
    ...
    _this.parent = window;
    _this.frame = iframe !== null && iframe !== void 0 ? iframe : document.createElement("iframe");
  ...
  _createClass(ParentAPI, [{
    ...
    value: function destroy() {
      var destroyIframe = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
