(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ibridge"] = factory();
	else
		root["ibridge"] = factory();
})(this, function() {
...
/* harmony import */ var _isValidEvent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./isValidEvent */ "./src/isValidEvent.ts");
...
var debug = debug__WEBPACK_IMPORTED_MODULE_0___default()("ibridge:child");

var ChildAPI = /*#__PURE__*/function (_Emittery) {
  _inherits(ChildAPI, _Emittery);

  var _super = _createSuper(ChildAPI);

  function ChildAPI(_ref) {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "parentOrigin", void 0);

    _defineProperty(_assertThisInitialized(_this), "context", void 0);

    _defineProperty(_assertThisInitialized(_this), "secure", void 0);

    _this.child = window;
    _this.parent = _this.child.parent;
    _this.model = model;
  ...
  _createClass(ChildAPI, [{
    ...
    value: function setListeners() {
      ...
      this.on(_constants__WEBPACK_IMPORTED_MODULE_3__.GET_REQUEST, this.handleGet.bind(this));
    }
  }, {
    key: "dispatcher",
    value: function () {
      var _dispatcher = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
        var data, type, kind, eventName, isHandshake, _ref2, _eventName, _data;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (this.secure && !this.parentOrigin) {
                  ...
                  isHandshake = kind === _constants__WEBPACK_IMPORTED_MODULE_3__.PARENT_EMIT && eventName === _constants__WEBPACK_IMPORTED_MODULE_3__.HANDHSAKE_START && type === _constants__WEBPACK_IMPORTED_MODULE_3__.MESSAGE_TYPE;
                ...
                debug("parent origin mismatch. Expected %s got %s", this.parentOrigin, event.origin);
                return _context.abrupt("return");

              case 5:
                if (event.data.kind === _constants__WEBPACK_IMPORTED_MODULE_3__.PARENT_EMIT) {
                  _ref2 = event.data, _eventName = _ref2.eventName, _data = _ref2.data;
                  debug("dispatcher emit internally \"%s\" with data %O", _eventName, _data);
    ...
    key: "emitToParent",
    value: function emitToParent(eventName, data) {
      debug("emitToParent \"%s\" with data %O", eventName, data);
      this.parent.postMessage((0,_events__WEBPACK_IMPORTED_MODULE_4__.createChildEmit)(eventName, data), this.secure ? this.parentOrigin : "*");
    }
  }, {
    key: "handshake",
    value: function () {
      var _handshake = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.once(_constants__WEBPACK_IMPORTED_MODULE_3__.HANDHSAKE_START);

              case 2:
                debug("received handshake from Parent");
                debug("sending handshake reply to Parent");
                this.emitToParent(_constants__WEBPACK_IMPORTED_MODULE_3__.HANDSHAKE_REPLY, undefined);
                debug("handshake ok");
    ...
    key: "handleGet",
    value: function () {
      var _handleGet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(_ref3) {
  ...
  return ChildAPI;
}((emittery__WEBPACK_IMPORTED_MODULE_1___default()));
...
var ParentAPI = /*#__PURE__*/function (_Emittery) {
  ...
  function ParentAPI(_ref) {
    ...
    var _ref$container = _ref.container,
        ...
        _ref$showIframe = _ref.showIframe,
        showIframe = _ref$showIframe === void 0 ? false : _ref$showIframe,
        _ref$secure = _ref.secure,
        secure = _ref$secure === void 0 ? true : _ref$secure;
    ...
    _defineProperty(_assertThisInitialized(_this), "childOrigin", void 0);
    ...
    (_this$frame$classList = _this.frame.classList).add.apply(_this$frame$classList, _toConsumableArray(classList));

    _this.secure = secure;

    if (!showIframe) {
      // Make it invisible
      _this.frame.style.width = "0";
      _this.frame.style.height = "0";
      _this.frame.style.border = "0";
    }
  ...
  _createClass(ParentAPI, [{
    ...
    value: function emitToChild(eventName, data) {
      ...
      this.child.postMessage((0,_events__WEBPACK_IMPORTED_MODULE_2__.createParentEmit)(eventName, data), this.secure ? this.childOrigin : "*");
    }
  }, {
    key: "handshake",
    value: function () {
      var _handshake = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        var _this2 = this;

        var attempt, tryHandshake;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                tryHandshake = /*#__PURE__*/function () {
                  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                    return regeneratorRuntime.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            if (!(attempt < ParentAPI.maxHandshakeRequests)) {
                              _context.next = 17;
                              break;
                            }
                ...
                return _context3.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  _this2.frame.addEventListener("load", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                    return regeneratorRuntime.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
...
_defineProperty(ParentAPI, "maxHandshakeRequests", 5);
...
/* harmony export */   "HANDHSAKE_START": () => /* binding */ HANDHSAKE_START,
/* harmony export */   "HANDSHAKE_REPLY": () => /* binding */ HANDSHAKE_REPLY,
/* harmony export */   "PARENT_EMIT": () => /* binding */ PARENT_EMIT,
/* harmony export */   "CHILD_EMIT": () => /* binding */ CHILD_EMIT,
/* harmony export */   "GET_REQUEST": () => /* binding */ GET_REQUEST,
/* harmony export */   "GET_RESPONSE": () => /* binding */ GET_RESPONSE
/* harmony export */ });
var MESSAGE_TYPE = "application/x-ibridge-v1+json";
var HANDHSAKE_START = "handshake";
var HANDSHAKE_REPLY = "handshake-reply";
var PARENT_EMIT = "parent-emit";
var CHILD_EMIT = "child-emit";
var GET_REQUEST = "get-request";
...
/* harmony export */   "createChildEmit": () => /* binding */ createChildEmit,
/* harmony export */   "createParentEmit": () => /* binding */ createParentEmit
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/constants.ts");

function getResponse(id) {
  return "".concat(_constants__WEBPACK_IMPORTED_MODULE_0__.GET_RESPONSE, "/").concat(id);
}
function createChildEmit(eventName, data) {
  return {
    type: _constants__WEBPACK_IMPORTED_MODULE_0__.MESSAGE_TYPE,
    kind: _constants__WEBPACK_IMPORTED_MODULE_0__.CHILD_EMIT,
    eventName: eventName,
    data: data
  };
}
function createParentEmit(eventName, data) {
  return {
    type: _constants__WEBPACK_IMPORTED_MODULE_0__.MESSAGE_TYPE,
    kind: _constants__WEBPACK_IMPORTED_MODULE_0__.PARENT_EMIT,
    eventName: eventName,
    data: data
  };
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Parent": () => /* reexport safe */ _Parent__WEBPACK_IMPORTED_MODULE_1__.default,
/* harmony export */   "Child": () => /* reexport safe */ _Child__WEBPACK_IMPORTED_MODULE_2__.default,
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! regenerator-runtime/runtime.js */ "./node_modules/regenerator-runtime/runtime.js");
/* harmony import */ var regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Parent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Parent */ "./src/Parent.ts");
/* harmony import */ var _Child__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Child */ "./src/Child.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  Child: _Child__WEBPACK_IMPORTED_MODULE_2__.default
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => /* binding */ isValidEvent
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/constants.ts");
...
function isValidEvent(event, allowedOrigin) {
  var validators = [function () {
    ...
    return ((_event$data = event.data) === null || _event$data === void 0 ? void 0 : _event$data.type) === _constants__WEBPACK_IMPORTED_MODULE_0__.MESSAGE_TYPE;
  }];
